...
import kotlinx.android.synthetic.main.chat_ballon.view.*
import java.util.*

class MessageListAdapter(val context: Context,val messageList:List<Message>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
